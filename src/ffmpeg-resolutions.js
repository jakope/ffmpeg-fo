export default [
  {
    ...
    h264_mediacodec:
      '-c:v h264_mediacodec -b:v 500k -maxrate:v 500k -bufsize:v 1000k'.split(
        ' '
      ),
  },
  {
    ...
    h264_mediacodec:
      '-c:v h264_mediacodec -b:v 1000k -maxrate:v 1000k -bufsize:v 2000k'.split(
        ' '
      ),
  },
  {
    ...
    h264_mediacodec:
      '-c:v h264_mediacodec -b:v 3000k -maxrate:v 4000k -bufsize:v 6000k'.split(
        ' '
      ),
  },
  {
    ...
    h264_mediacodec:
      '-c:v h264_mediacodec -b:v 4000k -maxrate:v 4000k -bufsize:v 8000k'.split(
        ' '
      ),
  },
  {
    ...
    h264_nvenc:
      '-c:v h264_nvenc -preset slow -qmin 16 -qmax 28 -cq 18 -b:v 8000k -pix_fmt nv12'.split(
        ' '
      ),
    h264_qsv:
      '-c:v h264_qsv -b:v 8000k -maxrate:v 4000k -bufsize:v 8000k -quality 29 -pix_fmt nv12'.split(
        ' '
      ),
    h264_videotoolbox:
    ...
    h264_mediacodec:
      '-c:v h264_mediacodec -b:v 8000k -maxrate:v 8000k -bufsize:v 8000k'.split(
        ' '
      ),
  },
];
